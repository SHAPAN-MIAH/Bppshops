...
import nuxt_plugin_plugin_5ed71aeb from 'nuxt_plugin_plugin_5ed71aeb' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_workbox_313fbdac from 'nuxt_plugin_workbox_313fbdac' // Source: .\\workbox.js (mode: 'client')
import nuxt_plugin_metaplugin_39d44baa from 'nuxt_plugin_metaplugin_39d44baa' // Source: .\\pwa\\meta.plugin.js (mode: 'all')
import nuxt_plugin_axios_6bf150e4 from 'nuxt_plugin_axios_6bf150e4' // Source: .\\axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_5ed71aeb === 'function') {
    await nuxt_plugin_plugin_5ed71aeb(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_313fbdac === 'function') {
    await nuxt_plugin_workbox_313fbdac(app.context, inject)
  }

  if (typeof nuxt_plugin_metaplugin_39d44baa === 'function') {
    await nuxt_plugin_metaplugin_39d44baa(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_6bf150e4 === 'function') {
    await nuxt_plugin_axios_6bf150e4(app.context, inject)
  }
